...
const Stack = ({
    ...
    const [allCards, setAllCards] = useState(
        [
            ...
            { id: 10, img: p7, script: "Matlab camera effect ya feelings?" },
            { id: 11, img: s1, script: "Dono" },
            { id: 12, img: s1, script: "Aur haan, keh raha tha 'agar tu haan bol de, to wo full softboi ban jaayega'." },
            { id: 13, img: p8, script: "Acha? Dekhte hain phir, kitna soft hota hai." },
            { id: 14, img: s1, script: "Hope detected." },
            { id: 15, img: p5, script: "Usko kya kaam hai mujhse? Time nahi hai abhi." },
